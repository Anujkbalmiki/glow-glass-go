...
function Brand() { return <div className="flex items-center gap-2.5 px-3"><div className="grid size-9 place-items-center rounded-[10px] bg-ink font-display text-sm font-bold tracking-tight text-primary-foreground">QR</div><div className="leading-tight"><p className="font-display text-sm font-bold tracking-tight">QR Payslip</p><p className="font-mono text-[10px] uppercase tracking-[0.18em] text-ink-soft">Payroll OS</p></div></div>; }
